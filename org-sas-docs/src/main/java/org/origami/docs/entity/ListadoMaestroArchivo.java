...
@Document(collection = "listado_maestro_archivo")
public class ListadoMaestroArchivo {
    @Id
    public String _id;
    ...
    public boolean equals(Object o) {
        ...
        ListadoMaestroArchivo archivo = (ListadoMaestroArchivo) o;
