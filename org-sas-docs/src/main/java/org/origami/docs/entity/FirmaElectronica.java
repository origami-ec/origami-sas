...
public class FirmaElectronica {
    ...
    public FirmaElectronica(String _id, String archivo, String clave, Boolean estado, Date fechaCreacion, String tipoFirma, String ubicacion, Usuario usuario, String estadoFirma, String uid, String cn, String emision, Boolean firmaCaducada) {
        this._id = _id;
