...
public class SearchSubword {
    ...
    public Boolean exitsSubwords(PDDocument document, String searchTerm) throws IOException {
        ...
        for (int page = 1; page <= document.getNumberOfPages(); page++) {
            ...
            if (hits != null && !hits.isEmpty()) {
                for (TextPositionSequence hit : hits) {
                    ...
                    System.out.println(searchTerm.toLowerCase() + " :::contains::: " + hit.getWord().toLowerCase());

                    if (searchTerm.toLowerCase().contains(hit.getWord().toLowerCase())) {
                        return Boolean.TRUE;
                        //break;
                    } else {
        ...
        for (int page = 1; page <= document.getNumberOfPages(); page++) {
            ...
            if (hits != null && !hits.isEmpty()) {
                ...
                for (TextPositionSequence hit : hits) {
                    ...
                    if (searchTerm.equals(hit.getWord())) {
    ...
    public void printSubwordsImproved(PDDocument document, String searchTerm) throws IOException {
        ...
        for (int page = 1; page <= document.getNumberOfPages(); page++) {
            ...
            for (TextPositionSequence hit : hits) {
                ...
                System.out.printf("lastPosition: %s, %s, %s, %s, %s, %s, %s,, %s,, %s,, %s",
