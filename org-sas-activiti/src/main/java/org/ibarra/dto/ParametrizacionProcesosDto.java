...
public class ParametrizacionProcesosDto {
    private Long id;
    ...
    public ParametrizacionProcesosDto() {

    }

    public ParametrizacionProcesosDto(String idTarea, String abreviaturaProceso) {
    ...
    public String toString() {
        return "ParametrizacionProcesosDto{" +
                "id=" + id +
                ", idTarea='" + idTarea + '\'' +
                ", rol='" + rol + '\'' +
