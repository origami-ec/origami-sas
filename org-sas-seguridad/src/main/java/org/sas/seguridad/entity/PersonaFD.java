...
@Entity
@Table(name = "persona", schema = "adm_fin_public")
public class PersonaFD implements Serializable {
    ...
    public PersonaFD(Long id, String numIdentificacion, String nombre, String apellido, String domicilio, String correo, String telefono, String celular,   Boolean estado, String estadoCivil,   String condicionCiudadano,
    ...
    public PersonaFD(Long id) {
        this.id = id;
    }


    public PersonaFD(String identificacion) {
        this.numIdentificacion = identificacion;
    }



    public PersonaFD(Long id, String numIdentificacion) {
        if (id != null) {
            this.id = id;
        } else {
            this.numIdentificacion = numIdentificacion;
