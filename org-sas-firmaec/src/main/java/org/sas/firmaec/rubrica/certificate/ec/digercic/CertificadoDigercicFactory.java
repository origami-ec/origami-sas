 ...
 */
package org.sas.firmaec.rubrica.certificate.ec.digercic;
...
public class CertificadoDigercicFactory {
    ...
    public static boolean esCertificadoDigercic(X509Certificate certificado) {
        return (certificateHasPolicy(certificado, CertificadoDigercic.OID_CERTIFICADO_PERSONA_NATURAL));
    }

    public static CertificadoDigercic construir(X509Certificate certificado) {
        if (certificateHasPolicy(certificado, CertificadoDigercic.OID_CERTIFICADO_PERSONA_NATURAL)) {
