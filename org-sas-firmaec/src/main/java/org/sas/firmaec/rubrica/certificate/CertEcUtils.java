 ...
 */
package org.sas.firmaec.rubrica.certificate;

import org.sas.firmaec.rubrica.certificate.ec.*;
import org.sas.firmaec.rubrica.certificate.ec.alphatechnologies.AlphaTechnologiesSubCaCert20232026;
import org.sas.firmaec.rubrica.certificate.ec.alphatechnologies.CertificadoAlphaTechnologies;
import org.sas.firmaec.rubrica.certificate.ec.alphatechnologies.CertificadoAlphaTechnologiesFactory;
import org.sas.firmaec.rubrica.certificate.ec.anfac.*;
import org.sas.firmaec.rubrica.certificate.ec.argosdata.*;
import org.sas.firmaec.rubrica.certificate.ec.bce.BceSubCaCert20112021;
import org.sas.firmaec.rubrica.certificate.ec.bce.BceSubCaCert20192029;
import org.sas.firmaec.rubrica.certificate.ec.bce.CertificadoBancoCentral;
import org.sas.firmaec.rubrica.certificate.ec.bce.CertificadoBancoCentralFactory;
import org.sas.firmaec.rubrica.certificate.ec.cj.*;
import org.sas.firmaec.rubrica.certificate.ec.corpnewbest.*;
import org.sas.firmaec.rubrica.certificate.ec.datil.*;
import org.sas.firmaec.rubrica.certificate.ec.digercic.CertificadoDigercic;
import org.sas.firmaec.rubrica.certificate.ec.digercic.CertificadoDigercicFactory;
import org.sas.firmaec.rubrica.certificate.ec.digercic.DigercicSubCaCert20212031;
import org.sas.firmaec.rubrica.certificate.ec.eclipsoft.*;
import org.sas.firmaec.rubrica.certificate.ec.firmasegura.CertificadoFirmaSegura;
import org.sas.firmaec.rubrica.certificate.ec.firmasegura.CertificadoFirmaSeguraFactory;
import org.sas.firmaec.rubrica.certificate.ec.firmasegura.CertificadoRepresentanteLegalFirmaSegura;
import org.sas.firmaec.rubrica.certificate.ec.firmasegura.FirmaSeguraSubCaCert20232043;
import org.sas.firmaec.rubrica.certificate.ec.lazzate.*;
import org.sas.firmaec.rubrica.certificate.ec.securitydata.*;
import org.sas.firmaec.rubrica.certificate.ec.uanataca.*;
import org.sas.firmaec.rubrica.certificate.to.DatosUsuario;
import org.sas.firmaec.rubrica.exceptions.EntidadCertificadoraNoValidaException;
import org.sas.firmaec.rubrica.utils.Utils;
        ...
        switch (entidadCertStr) {
            ...
            case UANATACA_NAME: {
                try {
                    ...
                    if (Utils.verifySignature(certificado, new UanatacaSubCaCert0320212034())) {
            ...
            case LAZZATE_NAME: {
                try {
                    if (Utils.verifySignature(certificado, new LazzateSubCaCert())) {
                        System.out.println("LazzateCA 2022-2037");
                        return new LazzateSubCaCert();
                    }
                    if (Utils.verifySignature(certificado, new LazzateSubCa1Cert())) {
                        System.out.println("LazzateCA1 2023-2053");
                        return new LazzateSubCa1Cert();
                    }
                    if (Utils.verifySignature(certificado, new LazzateSubCa2Cert())) {
                        System.out.println("LazzateCA2 2023-2053");
                        return new LazzateSubCa2Cert();
                    }
                    if (Utils.verifySignature(certificado, new LazzateSubCaWeGoCert())) {
...
//                return new LazzateSubCaCert();
            ...
            case ALPHATECHNOLOGIES_NAME: {
                try {
                    if (Utils.verifySignature(certificado, new AlphaTechnologiesSubCaCert20232026())) {
            ...
            case FIRMASEGURA_NAME: {
                try {
                    if (Utils.verifySignature(certificado, new FirmaSeguraSubCaCert20232043())) {
