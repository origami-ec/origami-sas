...
import org.sas.firmaec.rubrica.exceptions.CRLValidationException;
import org.sas.firmaec.rubrica.exceptions.ConexionValidarCRLException;
import org.sas.firmaec.rubrica.certificate.CertEcUtils;
import org.sas.firmaec.rubrica.certificate.CrlUtils;
import org.sas.firmaec.rubrica.certificate.ValidationResult;
import org.sas.firmaec.rubrica.exceptions.RubricaException;
import org.sas.firmaec.rubrica.exceptions.ConexionApiException;
import org.sas.firmaec.rubrica.exceptions.EntidadCertificadoraNoValidaException;

import org.sas.firmaec.rubrica.ocsp.ValidadorOCSP;
...
public class UtilsCrlOcsp {
    ...
    private static final int TIME_OUT = 3000; //set timeout to 5 seconds
    ...
    public static Date validarFechaRevocado(X509Certificate cert)     {
        ...
        } catch (ParseException | RubricaException | ConexionValidarCRLException | CRLValidationException | EntidadCertificadoraNoValidaException | IOException ex) {
